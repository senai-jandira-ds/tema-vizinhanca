...
<table>
  ...
  <tbody>
    <tr>
      <td>17/03/2026</td>
      <td><a target="blank" href="https://github.com/leonardo-scotti">Leonardo Scotti</a></td>
...
| :--: | :--------- | :-------- |
| Documentação | 1. Protótipo de Alta Fidelidade<br> 2. Requisitos Funcionais<br> 3. Requisitos Não Funcionais<br> | 1. Simulação do produto final<br> 2. Visão ampla do software<br> 3. Documentos que auxiliarão no entendimento por parte do público externo no projeto |
| Código | 1. Código Front-end<br> 2. Código Back-end<br> 3. Código Banco de Dados<br> 4. Código Mobile | 1. Entrega das funcionalidades funcionando<br> 2. Entrega do software com as funcionalidades aprimoradas |
...
| :----------: | :------------- |
| [@Joao-Meyer](https://github.com/Joao-Meyer) | Produto Final |
| [@fernandoleonid](https://github.com/fernandoleonid) | Produto Final |
| [@marcelnt](https://github.com/marcelnt) | Produto Final |
| [@yurikomuta](https://github.com/yurikomuta) | Produto Final |

## 3.3 Papéis
| Nome | Posição |
| :--: | :-----: |
| [Leonardo Scotti](https://github.com/leonardo-scotti) | Back-end |
| [Roger Ribeiro](https://github.com/rgrrb) | Front-end |
| [Giovana Barbosa](https://github.com/giovana-lua) | DBA |
| [Breno Machado](https://github.com/brenex920) | Mobile |
...
| Papel | Data de início | Data final | Esforço |
| :---: | :------------: | :--------: | :-----: |
| Mobile | 29/09/2020 | 26/10/2020 | 100% |
...
| :-----: | :---------: | :------: | :-----------------: | :----------------: | :----------: |
| Back-end | Jandira - São Paulo | Menos que bacharelado | 1 ano | <ul><li>JavaScript</li><li>Express</li><li>Swagger</li><li>Postman</li></ul> | R$13,00
| Front-end | Jandira - São Paulo | Menos que bacharelado | 1 ano | <ul><li>HTML</li><li>CSS</li><li>JavaScript</li><li>React.js</li></ul> | R$11,00
| DBA | Jandira - São Paulo | Menos que bacharelado | 1 ano | <ul><li>MySQL</li><li>SQL</li></ul> | R$14,00
| Mobile | Jandira - São Paulo | Menos que bacharelado | 1 ano | <ul><li>Kotlin</li></ul> | R$13,00

<dl>
    <dt>Explicação dos critérios:</dt>
        <dd>Posição: cada um da equipe tem a sua própria área de atuação, mas nada impede um membro ajudar o outro, mesmo que seja em outra área.</dd>
        <dd>Localização: como somos todos de Jandira o valor foi colocado como mão de obra de nossa localização.</dd>
        ...
        <dd>Tecnologias: conforme levantado em reunião, decidimos quais seriam as melhores tecnologias para serem usadas no projeto.</dd>
</dl>
...
1. [Salário Back-end](https://www.glassdoor.com.br/Sal%C3%A1rios/desenvolvedor-back-end-junior-sal%C3%A1rio-SRCH_KO0,29.htm)<br>
2. [Salário Front-end](https://www.glassdoor.com.br/Sal%C3%A1rios/desenvolvedor-front-end-junior-sal%C3%A1rio-SRCH_KO0,30.htm)<br>
3. [Salário Mobile](https://www.glassdoor.com.br/Sal%C3%A1rios/desenvolvedor-mobile-junior-sal%C3%A1rio-SRCH_KO0,27.htm)<br>
3. [Salário DBA](https://www.glassdoor.com.br/Sal%C3%A1rios/dba-junior-sal%C3%A1rio-SRCH_KO0,10.htm)<br>
4. [www.projectmanager.com](https://www.projectmanager.com/templates/project-charter-template?a=downloadGateUnlock&r=5d7ac3d9ae36e&e=Y2F1ZW1hdGV1c0Bob3RtYWlsLmNvbQ==)