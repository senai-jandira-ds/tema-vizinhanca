...
public class EmailService {
    ...
    public void sendWelcomeEmail(String to, String name, String password) throws MessagingException {
        MimeMessage message = mailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");

        helper.setTo(to);
        helper.setSubject("Bem-vindo ao Vizinhança! Suas credenciais de acesso.");
        helper.setFrom("leonardo.scotti07@gmail.com");
        helper.setText(buildHtml(name, to, password), true);
        ...
        return """
            ...
            <head>
              ...
              <style>
                ...
                .banner { background-color: #1a4fa3; padding: 32px 24px 24px; text-align: center; }
                .banner img { height: 54px; object-fit: contain; }
            ...
            <body>
              <div class="wrapper">
                ...
                <div class="body">
                  ...
                  <p class="warning">
                    🔒 Por segurança, recomendamos que você altere sua password após o primeiro acesso.
