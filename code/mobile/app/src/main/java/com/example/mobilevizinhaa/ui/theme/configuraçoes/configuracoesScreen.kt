...
import androidx.compose.runtime.LaunchedEffect // IMPORTANTE: Gatilho para carregar da API
import androidx.compose.runtime.collectAsState
// ====================================================================
// CRUCIAL: Esses dois imports resolvem o erro "Property delegate must have a getValue"
...
fun PerfilScreen(
    ...
    // 2. Dispara a busca automática no Swagger assim que a tela abre
    LaunchedEffect(Unit) {
        if (token.isNotEmpty()) {
    ...
    // 3. Coleta o estado de maneira estável. (Caso o Kotlin ainda reclame do 'by',
    // troque por: val residentState = viewModel.residentData.collectAsState() e use residentState.value)
    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                // Header Dinâmico mapeado perfeitamente para as suas variáveis do Swagger
                ProfileHeader(
